        ...
        <footer class="footer">
            <div class="footer__address-boxes">
                <div class="footer__address-box">
                    <div class="footer__address-box--inner">
                ...
                <div class="footer__address-box">
                    <div class="footer__address-box--inner">
                        <div class="footer__info">
                            <p class="footer__office"><?php echo get_option( 'office-3' ); ?></p>
                            <?php if( get_option('phone-3') ): ?><p class="footer__phone"><a href="tel:<?php echo get_option( 'phone-3' ); ?>"><?php echo get_option( 'phone-3' ); ?></a></p><?php endif; ?>
                            <?php if( get_option('address-3') ): ?><p class="footer__address"><?php echo get_option( 'address-3' ); ?></p><?php endif; ?>
                        </div>
                        <div class="footer__info--back">
                            <img class="footer__hover-image wp-image-<?php echo attachment_url_to_postid( get_option( 'footer-box-image-3' ) ); ?>" src="<?php echo get_option( 'footer-box-image-3' ); ?>" />
                            <div class="footer__info">
                                <p class="footer__office"><?php echo get_option( 'office-3' ); ?></p>
                                <?php if( get_option('phone-3') ): ?><p class="footer__phone"><a href="tel:<?php echo get_option( 'phone-3' ); ?>"><?php echo get_option( 'phone-3' ); ?></a></p><?php endif; ?>
                                <?php if( get_option('address-3') ): ?><p class="footer__address"><?php echo get_option( 'address-3' ); ?></p><?php endif; ?>
